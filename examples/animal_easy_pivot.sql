...
create table #animal_data (
	...
	skin_or_fur_color VARCHAR(50),
	survives_well VARCHAR(50),
	number_of_offspring INT,
	lives_in_time_zone VARCHAR(50),
...
select
	...
	animal_gender,
	skin_or_fur_color,
    case when survives_well = 'true' then 'Survival of fittest winner' else 'Goes extinct' end as 'Darwin Award Status',
	number_of_offspring,
	lives_in_time_zone,
	quantity_left_in_wild
into
	#animal_data_temp_table
from
	#animal_data
...
DECLARE @source_table AS NVARCHAR(MAX)= '#animal_data_temp_table'
...
[
    {
        "Group": ["animal_id", "quantity_left_in_wild", "number_of_offspring"],
        "Pivot": [
