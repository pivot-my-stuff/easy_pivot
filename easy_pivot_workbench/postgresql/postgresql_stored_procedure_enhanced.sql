-- Easy Pivot for PostgreSQL
-- Enhanced stored-procedure version
--
-- Parameters:
...
BEGIN
    ...
    (
        SELECT value
        FROM jsonb_array_elements(p_json_configuration)
    )
    LOOP
    ...
    (
        ...
        (
            ...
            FROM
                jsonb_array_elements(p_json_configuration) cfg(config)
			CROSS JOIN LATERAL
