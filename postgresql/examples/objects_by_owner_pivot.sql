----------------------------------------------------------------------------
-- Example: Objects by Owner Pivot
----------------------------------------------------------------------------
--
-- Demonstrates a simple COUNT() pivot using PostgreSQL's built-in
-- pg_tables system catalog.
--
-- This example counts the number of tables owned by each PostgreSQL
-- user within each schema.
--
-- Group:
--
--     tableowner
