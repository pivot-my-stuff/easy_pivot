----------------------------------------------------------------------------
-- Example: Multiple Aggregates Pivot
----------------------------------------------------------------------------
--
-- Demonstrates multiple aggregate functions using the same pivot
-- field and pivot data.
--
-- This example calculates both COUNT() and MAX() values for each
-- schema associated with every table owner.
--
-- Group:
--
--     tableowner
...
[
  {
    ...
    "Pivot": [
	     {"Pivot_Field": "schemaname", "Pivot_Type": "Count", "Pivot_Data": "tablename"}
	    ,{"Pivot_Field": "schemaname", "Pivot_Type": "Max",   "Pivot_Data": "tablename"}
	]
  }
]
