...
Example: furniture_sales_easy_pivot.sql

Demonstrates:

    * Multiple Group fields
    * Group ordering using ASC and DESC choices
    * Independent pivot ordering
    * Multiple aggregate pivots against the same source field
    * Independent ordering choices for each pivot
...
SELECT *
INTO #furniture_sales
FROM
(
    VALUES
        ('East',  'Detroit',     'Chair',  12500),
        ('East',  'Detroit',     'Desk',   18400),
        ('East',  'Detroit',     'Table',  22100),

        ('East',  'Chicago',     'Chair',  14200),
        ('East',  'Chicago',     'Desk',   20100),
        ('East',  'Chicago',     'Table',  17500),

        ('East',  'Toledo',      'Chair',  10800),
        ('East',  'Toledo',      'Desk',   15300),
        ('East',  'Toledo',      'Table',  19200),

        ('West',  'Phoenix',     'Chair',  18700),
        ('West',  'Phoenix',     'Desk',   22100),
        ('West',  'Phoenix',     'Table',  26800),

        ('West',  'Denver',      'Chair',  17400),
        ('West',  'Denver',      'Desk',   21000),
        ('West',  'Denver',      'Table',  24700),

        ('West',  'Seattle',     'Chair',  20300),
        ('West',  'Seattle',     'Desk',   23600),
        ('West',  'Seattle',     'Table',  28100)
) AS data
(
    REGION,
    CITY,
