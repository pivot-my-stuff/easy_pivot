...
Example: apps_easy_pivot.sql

Demonstrates:

    * Real-world dashboard style reporting
    * Boolean pivots
    * Aggregate pivots
    * Follows_Group placement control
    * Multiple pivots against the same source field
    * Missing pivot values and sparse data
...
(
    VALUES
        ...
        ('Inventory',    'Development', 1, 10),
        ('Inventory',    'Production',  1, 14),

        ('Scheduling',   'Development', 1,  7),
        ('Scheduling',   'Test',        1,  9),

        ('Reporting',    'Development', 1, 11),
        ('Reporting',    'Test',        1, 13),
        ('Reporting',    'Production',  1, 20),

        ('Payroll',      'Production',  1, 16)
) AS data
(
    APPLICATION_NAME,
    ENVIRONMENT,
...
DECLARE @source_table AS NVARCHAR(MAX)= '#applications'
